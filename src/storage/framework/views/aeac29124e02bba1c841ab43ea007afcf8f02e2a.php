<?php $__env->startSection('title', 'STYLE'); ?>
...
<div class="container-fluid bg-dark p-5 mb-5">
    <div class="row">
        <div class="col-12 text-center">
            <h1 class="display-4 text-uppercase text-white"><?php echo e($style->name); ?></h1>
            <!-- <a href="">Top</a> -->
...
<div class="text-center">
    <a href="<?php echo e(action('TopController@style')); ?>"><i class="fa fa-arrow-circle-left text-primary mt-5" aria-hidden="true"></i> STYLE 一覧に戻る</a>
</div>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/beers_memo/resources/views/front/styleindex.blade.php ENDPATH**/ ?>