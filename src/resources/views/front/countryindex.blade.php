...
<div class="container-fluid bg-dark p-5 mb-5">
    <div class="row">
        <div class="col-12 text-center">
            <h1 class="display-4 text-uppercase text-white">{{ $country->name }}</h1>
            <!-- <a href="">Top</a> -->
...
<div class="text-center">
    <a href="{{ action('TopController@country') }}"><i class="fa fa-arrow-circle-left text-primary mt-5" aria-hidden="true"></i> COUNTRY 一覧に戻る</a>
</div>
